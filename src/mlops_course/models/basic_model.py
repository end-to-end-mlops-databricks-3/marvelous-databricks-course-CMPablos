...
class BasicModel:
    ...
    def prepare_features(self) -> None:
        ...
        features. Constructs a pipeline combining preprocessing and LightGBM categorical model.
        """
    ...
    def log_model(self) -> None:
        ...
        with mlflow.start_run(tags=self.tags) as run:
            ...
            dataset = mlflow.data.from_spark(
                ...
                table_name=f"{self.catalog_name}.{self.schema_name}.hotel_reservations_train_set",
